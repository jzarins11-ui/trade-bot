...
if not ALPACA_KEY or not ALPACA_SECRET:
    log.error("CRITICAL: ALPACA_KEY or ALPACA_SECRET missing from environment/keys.env")
    # We don't exit here to allow backtests to potentially run if data is local, 
    # but live trading will fail.
